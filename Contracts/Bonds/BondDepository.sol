...
contract fGhostBondDepository is IBondDepository, NoteKeeper {
/* ======== DEPENDENCIES ======== */
...
/* ======== DEPOSIT ======== */
   ...
   * @return payout_     the amount of FGHST due
...
/* ======== CREATE ======== */
   ...
   * @param _market      [capacity (in FGHST or quote), initial price / FGHST (9 decimals), debt buffer (3 decimals)]
  ...
  function create(
     ...
     */
    uint256 controlVariable = _market[1] * fghst.balanceOf(address(this)) / targetDebt;
    ...
    emit CreateMarket(id_, address(fghst), address(_quoteToken), _market[1]);
  } 
...
/* ======== EXTERNAL VIEW ======== */
   ...
   * @param _id          ID of market
   * @return             price for market in FGHST decimals
   *
   ...
   * @param _id          ID of market
   * @return             current debt for market in FGHST decimals
   */
